    ...
    <div className="min-h-screen gradient flex">
      <div className="bg-white px-16 py-12 max-w-lg m-auto rounded-lg shadow-lg">
        <div className="text-center">
          ...
          <h1 className="mt-2 text-2xl font-medium text-secondary">
            Sign in
          </h1>
        </div>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
              <input 
                ...
                type="checkbox" 
                value="" 
                class="w-4 h-4 text-primary rounded accent-secondary" 
              />
              <label className="items-center align-middle text-secondary text-md font-medium ml-1 mr-4" for="checkbox">
                Remember me
              </label>
              <a href="/" 
